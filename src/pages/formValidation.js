        ...
        <form onSubmit={submit}>
            <div className='formGroup'>
                <label className='formLabel'>First name*</label>
                    <input className={ error.firstName ? 'formInput errorInput' : 'formInput'} type='text' name='firstName' value={change.firstName} onChange={inputChange} placeholder='enter your first name' />
                    {error.firstName &&
                        <p className='textError'>{error.firstName}</p>
                    }
            ...
            <div className='formGroup'>
                ...
                <input className={ error.email ? 'formInput errorInput' : 'formInput'} type='text' name='email' value={change.email} onChange={inputChange} placeholder='enter your email' />
                {error.email &&
                    <p className='textError'>{error.email}</p>
                }
            </div>

            <div className='formGroup'>
                <label className='formLabel'>Password*</label>
                <input className={ error.password ? 'formInput errorInput' : 'formInput'} type='password' name='password' value={change.password} onChange={inputChange} placeholder='enter your password' />
                {error.password &&
                    <p className='textError'>{error.password}</p>
                }

            </div>

            <div>
                <label className='formLabel'><input className='formCheckbox' type='checkbox' name='nda' onChange={inputChange} />Send me NDA*</label>
                {error.nda &&
                    <p className='textError'>'Необходимо принять согласие'</p>
                }
            </div>
            <div>
