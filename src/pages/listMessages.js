        ...
        {messagesList.map((name, index) => {
            return (
                <tr key={name} className=''>
                    <td className="cell-title"> <span className="text">{name}</span></td>
                    <td className="cell-active"><button onClick={() => deleteMessage(index)} className="btnDelete">delete</button>  </td>
